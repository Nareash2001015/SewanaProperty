<?php 
    ...
    $Emp_ID = $_GET['GetID'];
    $query = "select * from assistant where Emp_ID='".$Emp_ID."';";
...
<body>
        <form action="updateassistant.php?ID=<?php echo $Emp_ID ?>" method="post">
        ...
        <input class="form-control" type="text" name="Supervisor_ID" placeholder="supervisor ID of staff's supervisor" value="<?php echo $Supervisor_ID?>"><br>
        Enter the appointed date:
        <input class="form-control" type="date" name="Appoint_date" placeholder="appointed date" value="<?php echo $Appoint_date?>"><br>
