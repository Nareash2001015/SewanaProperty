...
<body>
        <form action="updatemanager.php?ID=<?php echo $Emp_ID ?>" method="post">
        ...
        <input class="form-control" type="number" name="Manager_no" placeholder="manager number" value="<?php echo $Manager_no?>"><br>
