<?php 
    ...
    $Emp_ID = $_GET['GetID'];
    $query = "select * from staff where Emp_ID='".$Emp_ID."';";
...
<body>
        <form action="updatestaff.php?ID=<?php echo $Emp_ID ?>" method="post">
        ...
        Enter the Job type:
        <input class="form-control" type="text" name="Job_type" placeholder="Job type" value="<?php echo $Job_type?>"><br>
