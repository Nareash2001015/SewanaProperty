<?php 
    ...
    
    {
        ...
        $query = "update supervisor set  supervisor_no='".$supervisor_no."',Emp_start_date='".$Emp_start_date."',Staff_type='".$Staff_type."',Emp_DOB='".$Emp_DOB."',Emp_NIC='".$Emp_NIC."',Emp_Name='".$Emp_Name."',Emp_contact_no='".$Emp_contact_no."',Emp_Gender='".$Emp_Gender."',Emp_salary='".$Emp_salary."' where Emp_ID='".$Emp_ID."';";
